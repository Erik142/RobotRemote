 ...
 * {@link manualControlFragment.OnManualFragmentInteractionListener} interface
...
public class manualControlFragment extends Fragment {
    ...
    private OnManualControlFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mListener.onManualControlFragmentInitialized();
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onManualControlFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnManualControlFragmentInteractionListener) activity;
     ...
     */
    public interface OnManualControlFragmentInteractionListener {
